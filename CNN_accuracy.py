...
for i in range(1000):
    ...
    #                        feed_dict={xs: train_x, ys: train_y, keep_prob: 0.5})
    _, loss_val = sess.run([train_step, cross_entropy],
                           feed_dict={xs: test_x, ys: test_y, keep_prob: 0.5})
    if i % 50 == 0:
        print("vali", compute_accuracy(test_x, test_y))
        print("train", compute_accuracy(train_x, train_y))